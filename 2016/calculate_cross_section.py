...
def calculate_cross_section(xs_inputs):

    fiducial_region_cuts_efficiency  =  xs_inputs["fiducial_region_cuts_efficiency"]
    n_signal_electron  =  xs_inputs["n_signal_electron"]
    n_signal_muon  =  xs_inputs["n_signal_muon"]
    n_signal_syst_unc_due_to_fake_photon_electron  =  xs_inputs["n_signal_syst_unc_due_to_fake_photon_electron"]
    n_signal_syst_unc_due_to_fake_photon_muon  =  xs_inputs["n_signal_syst_unc_due_to_fake_photon_muon"]
    n_signal_syst_unc_due_to_fake_lepton_electron  =  xs_inputs["n_signal_syst_unc_due_to_fake_lepton_electron"]
    n_signal_syst_unc_due_to_fake_lepton_muon  =  xs_inputs["n_signal_syst_unc_due_to_fake_lepton_muon"]
    n_signal_stat_unc_electron  =  xs_inputs["n_signal_stat_unc_electron"]
    n_signal_stat_unc_muon  =  xs_inputs["n_signal_stat_unc_muon"]
    n_weighted_selected_data_mc_sf_electron  =  xs_inputs["n_weighted_selected_data_mc_sf_electron"]
    n_weighted_selected_data_mc_sf_muon  =  xs_inputs["n_weighted_selected_data_mc_sf_muon"]
    n_weighted_run_over  =  xs_inputs["n_weighted_run_over"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_muon_id_sf_muon  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_muon_id_sf_muon"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_muon_iso_sf_muon  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_muon_iso_sf_muon"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_photon_id_sf_muon  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_photon_id_sf_muon"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_pdf_muon  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_pdf_muon"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_qcd_scale_muon  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_qcd_scale_muon"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_electron_id_sf_electron  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_electron_id_sf_electron"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_electron_reco_sf_electron  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_electron_reco_sf_electron"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_photon_id_sf_electron =   xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_photon_id_sf_electron"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_pdf_electron  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_pdf_electron"]
    n_weighted_selected_data_mc_sf_syst_unc_due_to_qcd_scale_electron  =  xs_inputs["n_weighted_selected_data_mc_sf_syst_unc_due_to_qcd_scale_electron"]
...
calculate_cross_section(xs_inputs)
