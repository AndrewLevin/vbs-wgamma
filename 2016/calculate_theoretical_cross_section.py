...
n_weighted_mg5amc_pass_gen_selection = mg5amc_wgjets_file.Get("nWeightedEventsPassFiducial").GetBinContent(1)
#n_weighted_mg5amc_pass_gen_selection = mg5amc_wgjets_file.Get("nWeightedEventsPassLHEAndGenSelection").GetBinContent(1)

lhe_to_gen_efficiency = n_weighted_mg5amc_pass_gen_selection/n_weighted_mg5amc_pass_lhe_selection
