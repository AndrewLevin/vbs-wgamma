...
n_weighted_mg5amc = mg5amc_wgjets_file.Get("nWeightedEvents").GetBinContent(1)
...
n_weighted_powheg_plus = powheg_plus_wgjets_file.Get("nWeightedEvents").GetBinContent(1)
n_weighted_powheg_minus = powheg_minus_wgjets_file.Get("nWeightedEvents").GetBinContent(1)
...
mg5amc_nlo_fiducial_xs =  mg5amc_nlo_xs*mg5amc_wgjets_file.Get("nWeightedEventsPassGenSelection").GetBinContent(1)/mg5amc_wgjets_file.Get("nWeightedEvents").GetBinContent(1)
...
for i in range(0,8):
    ...
    mg5amc_nlo_fiducial_xs_qcd_scale_i = mg5amc_nlo_xs*2*mg5amc_wgjets_file.Get("nWeightedEventsPassGenSelection_QCDScaleWeight"+str(i)).GetBinContent(1)/mg5amc_wgjets_file.Get("nWeightedEvents").GetBinContent(1)

    powheg_nlo_fiducial_xs_qcd_scale_i = powheg_plus_nlo_xs*3*powheg_plus_wgjets_file.Get("nWeightedEventsPassGenSelection_QCDScaleWeight"+str(i)).GetBinContent(1)/powheg_plus_wgjets_file.Get("nWeightedEvents").GetBinContent(1)+powheg_minus_nlo_xs*3*powheg_minus_wgjets_file.Get("nWeightedEventsPassGenSelection_QCDScaleWeight"+str(i)).GetBinContent(1)/powheg_minus_wgjets_file.Get("nWeightedEvents").GetBinContent(1) 
...
for i in range(1,102):
    mg5amc_nlo_fiducial_xs_mean_pdf+=mg5amc_nlo_xs*mg5amc_wgjets_file.Get("nWeightedEventsPassGenSelection_PDFWeight"+str(i)).GetBinContent(1)/mg5amc_wgjets_file.Get("nWeightedEvents").GetBinContent(1)
    powheg_nlo_fiducial_xs_mean_pdf+=powheg_plus_nlo_xs*3*powheg_plus_wgjets_file.Get("nWeightedEventsPassGenSelection_PDFWeight"+str(i)).GetBinContent(1)/powheg_plus_wgjets_file.Get("nWeightedEvents").GetBinContent(1)+powheg_minus_nlo_xs*3*powheg_minus_wgjets_file.Get("nWeightedEventsPassGenSelection_PDFWeight"+str(i)).GetBinContent(1)/powheg_minus_wgjets_file.Get("nWeightedEvents").GetBinContent(1)
...
for i in range(1,102):
    mg5amc_nlo_fiducial_xs_stddev_pdf += pow(mg5amc_nlo_xs*mg5amc_wgjets_file.Get("nWeightedEventsPassGenSelection_PDFWeight"+str(i)).GetBinContent(1)/mg5amc_wgjets_file.Get("nWeightedEvents").GetBinContent(1) - mg5amc_nlo_fiducial_xs_mean_pdf,2)
    powheg_nlo_fiducial_xs_stddev_pdf += pow(powheg_plus_nlo_xs*3*powheg_plus_wgjets_file.Get("nWeightedEventsPassGenSelection_PDFWeight"+str(i)).GetBinContent(1)/powheg_plus_wgjets_file.Get("nWeightedEvents").GetBinContent(1)+powheg_minus_nlo_xs*3*powheg_minus_wgjets_file.Get("nWeightedEventsPassGenSelection_PDFWeight"+str(i)).GetBinContent(1)/powheg_minus_wgjets_file.Get("nWeightedEvents").GetBinContent(1) - powheg_nlo_fiducial_xs_mean_pdf,2)
