...
\\label{tab:fake_photon_fractions}
\end{table}
"""%(
fake_photon_event_weights["muon_endcap"][0],
fake_photon_event_weights["electron_endcap"][0],
fake_photon_event_weights["muon_barrel"][0],
fake_photon_event_weights["electron_barrel"][0],
fake_photon_event_weights["muon_endcap"][1],
fake_photon_event_weights["electron_endcap"][1],
fake_photon_event_weights["muon_barrel"][1],
fake_photon_event_weights["electron_barrel"][1],
fake_photon_event_weights["muon_endcap"][2],
fake_photon_event_weights["electron_endcap"][2],
fake_photon_event_weights["muon_barrel"][2],
fake_photon_event_weights["electron_barrel"][2],
fake_photon_event_weights["muon_endcap"][3],
fake_photon_event_weights["electron_endcap"][3],
fake_photon_event_weights["muon_barrel"][3],
fake_photon_event_weights["electron_barrel"][3],
fake_photon_event_weights["muon_endcap"][4],
fake_photon_event_weights["electron_endcap"][4],
fake_photon_event_weights["muon_barrel"][4],
fake_photon_event_weights["electron_barrel"][4],
fake_photon_event_weights["muon_endcap"][5],
fake_photon_event_weights["electron_endcap"][5],
fake_photon_event_weights["muon_barrel"][5],
fake_photon_event_weights["electron_barrel"][5],
)
