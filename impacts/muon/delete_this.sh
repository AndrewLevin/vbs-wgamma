...
combineTool.py -M Impacts -d $label.root -m 125 --doInitialFit --robustFit 1 -t -1 --expectSignal=1
combineTool.py -M Impacts -d $label.root -m 125 --robustFit 1 --doFits  -t -1 --expectSignal=1
