...
date 2>&1 | tee wg_electron_zveto.txt; python -u wg.py --lep electron -o /eos/user/a/amlevin/www/wg/electron_zveto/ --phoeta both --year run2 --make_datacard --make_all_plots --zveto 2>&1 | tee -a wg_electron_zveto.txt; date 2>&1 | tee -a wg_electron_zveto.txt
...
date 2>&1 | tee wg_muon_mcfakephoton.txt; python -u wg.py --lep muon -o /eos/user/a/amlevin/www/wg/muon_mcfakephoton/ --phoeta both --year run2 --make_datacard --make_all_plots --use_wjets_for_fake_photon 2>&1 | tee -a wg_muon_mcfakephoton.txt; date 2>&1 | tee -a wg_muon_mcfakephoton.txt
